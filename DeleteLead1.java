...
public class DeleteLead1 extends LeadBaseClass{
    @Test
	public void deletingLead() throws InterruptedException {
		...
		//Enter Phone Number
		driver.findElement(By.name("phoneNumber")).sendKeys("45454545");
		//Click find leads
		driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
	    //capture lead
		Thread.sleep(2000);
		String idcap = driver.findElement(By.linkText("10131")).getText();
		driver.findElement(By.linkText("10131")).click();
		//click delete
